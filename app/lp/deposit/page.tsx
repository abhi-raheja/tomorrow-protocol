      ...
      <main className="lg:pl-64 pt-16">
        <div className="p-6 lg:p-8 max-w-2xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-white/50 mt-1">Add USDC to the pool and start earning yield</p>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/[0.08]">
            ...
            <div className="mb-6">
              ...
              {amount && !isValidAmount && numericAmount < 1000 && (
                <p className="text-sm text-red-400 mt-2">Minimum deposit is $1,000</p>
              )}
              {amount && numericAmount > 1000000 && (
                <p className="text-sm text-red-400 mt-2">Maximum deposit is $1,000,000</p>
              )}
            ...
            {/* Deposit Summary */}
            <div className="space-y-4 py-6 border-t border-white/[0.08]">
              <div className="flex justify-between">
                <span className="text-white/50">Estimated Shares</span>
              ...
              <div className="flex justify-between">
                ...
                <span className="text-emerald-400 font-medium">{poolMetrics.apy}%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/50">Pool Utilization</span>
                <span className="text-white font-medium">{poolMetrics.utilization}%</span>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-6 border-t border-white/[0.08]">
              {!isApproved ? (
                <Button
                  ...
                  className="flex-1 h-12 bg-white/10 hover:bg-white/15 text-white border border-white/20"
                >
                  {isApproving ? (
      ...
      <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
        <DialogContent className="sm:max-w-md bg-[#141414] border-white/10 text-center">
          <div className="py-6">
            ...
            <DialogHeader>
              <DialogTitle className="text-2xl font-semibold text-center">Deposit Successful!</DialogTitle>
            </DialogHeader>
